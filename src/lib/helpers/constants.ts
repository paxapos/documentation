...
export const navigation = [{ name: 'Manual de Usuario', href: '/user-guide' }];
...
export const searchableContentWithContent = [
	...
	},
	{
		...
		id: '23-Agregar-Personal',
		content:
			'La gestión del personal es fundamental para el funcionamiento del negocio. En esta sección podrás dar de alta a mozos, cajeros, cocineros y demás empleados que trabajarán con el sistema. Cada empleado puede tener roles específicos, horarios de trabajo, comisiones asignadas y permisos particulares según su función en el establecimiento.',
	},
	{
		title: 'Configuración de Impresoras',
		href: '/user-guide',
	...
	},
	{
		...
		id: '32-Salón',
		content:
			'El módulo de salón es el corazón operativo del sistema para restaurantes y bares. Aquí podrás gestionar mesas, tomar pedidos, dividir cuentas, aplicar descuentos y procesar pagos. La interfaz visual te permite ver el estado de cada mesa en tiempo real: libre, ocupada, con pedido listo, etc. Facilita enormemente la gestión del servicio al cliente.',
	},
	{
		title: 'Kitchen Display System (KDS)',
		href: '/user-guide',
		...
		id: '33-Kitchen-Display-System-(KDS)',
		content:
			'El Kitchen Display System KDS revoluciona la comunicación entre el salón y la cocina. Los pedidos se muestran automáticamente en pantallas de cocina, eliminando la necesidad de tickets impresos. Los cocineros pueden ver los pedidos en tiempo real, marcar platos como listos y gestionar los tiempos de preparación de manera más eficiente.',
	},
	{
		title: 'Contabilidad',
		href: '/user-guide',
	...
	},
	{
		...
		id: '35-Arqueos',
		content:
			'Los arqueos son fundamentales para el control de caja. Este módulo te permite realizar cierres diarios, conciliar efectivo y medios de pago, detectar diferencias y generar reportes detallados. Los arqueos aseguran la transparencia en el manejo del dinero y facilitan la detección temprana de irregularidades.',
	},
	{
		title: 'Compras y Stock',
		href: '/user-guide',
	...
	},
	{
		...
		id: '38-Estadísticas',
		content:
			'Toma decisiones informadas con el poderoso módulo de estadísticas. Analiza ventas por período, productos más vendidos, rendimiento del personal, horarios de mayor actividad y tendencias del negocio. Los reportes visuales y gráficos te ayudan a identificar oportunidades de crecimiento y áreas de mejora.',
	},
	{
		title: 'Business Intelligence',
		href: '/user-guide',
		...
		id: '39-Business-Intelligence',
		content:
			'El módulo de Business Intelligence te proporciona análisis avanzados y visualizaciones de datos para tomar decisiones estratégicas. Incluye dashboards interactivos, reportes personalizados, análisis de tendencias y predicciones basadas en el comportamiento histórico del negocio.',
	},
	{
		title: 'Biblioteca de Drivers',
		href: '/user-guide',
		...
		id: '41-Biblioteca-de-Drivers',
		content:
			'Accede a una biblioteca completa de controladores para impresoras fiscales y de comandas. Incluye drivers oficiales para marcas como Epson, SAM4S, Citizen, Hasar y más. Encuentra guías de instalación paso a paso y soluciones a problemas comunes de configuración de hardware.',
	},
	{
		title: 'Preguntas Frecuentes',
		href: '/user-guide',
		...
		id: '51-Preguntas-Frecuentes',
		content:
			'Encuentra respuestas rápidas a las dudas más comunes sobre el uso del sistema. Incluye soluciones a problemas técnicos, configuraciones específicas, troubleshooting y mejores prácticas recomendadas por nuestro equipo de soporte.',
	},
	{
		title: 'Buchón Bot',
		href: '/user-guide',
