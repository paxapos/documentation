...
<div id="guia-de-inicio-rapido"></div>
...
<div id="paso-1-iniciar-sesion"></div>

Entrá a [www.paxapos.com](https://www.paxapos.com) con el usuario y contraseña que te dieron.

> 🔗 Guía completa: [Cómo Iniciar Sesión](/user-guide/iniciar-sesion)
...
## 🖨️ Paso 4: Configurar tus impresoras
...
<div id="paso-5-activar-tus-medios-de-pago"></div>
...
<div id="paso-6-crear-usuarios-para-tu-equipo"></div>

Dale acceso a mozos, cajeros y encargados creando sus usuarios (o PIN, para un ingreso más rápido) en **Configuración** → **Usuarios del Sistema**.

> 🔗 Guías completas: [Usuarios del Sistema](/user-guide/usuarios-del-sistema) · [Usuarios con PIN](/user-guide/usuarios-con-pin)

---

## 🛎️ Paso 7: Abrir la caja y hacer tu primera venta
